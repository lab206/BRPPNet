...
class REFER:
    ...
    def __init__(self, data_root, dataset='rpcocos', splitBy='coco'):
        # provide data_root folder which contains rpcocos, rpcocom and rpcocol
        # also provide dataset name and splitBy information
        # e.g., dataset = 'rpcocos', splitBy = 'coco'
        print('loading dataset %s into memory...' % dataset)
        self.ROOT_DIR = osp.abspath(osp.dirname(__file__))
        self.DATA_DIR = osp.join(data_root, dataset)
        if dataset in ['rpcocos', 'rpcocom', 'rpcocol']:
        ...
        tic = time.time()
        ref_file = osp.join(self.DATA_DIR, 'rp('+splitBy+').p')
        self.data = {}
